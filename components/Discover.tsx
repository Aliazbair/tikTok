...
function Discover() {
    ...
    const activeTopicStyle='xl:border-2 hover:bg-gray-300 xl:border-[#f51997] px-3 py-2 rounded cursor-pointer text-[#f51997] xl:rounded-full flex items-center gap-2 justify-center';
    const topicStyle =
